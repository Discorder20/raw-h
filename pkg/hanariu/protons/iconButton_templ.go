...
var iconButtonStyles = hanariu.Boson{
	"current": "iconbutton-current",
}

var iconButtonSizeStyles = hanariu.Boson{
	"xs": "iconbutton-size-xs",
	"sm": "iconbutton-size-sm",
	"md": "iconbutton-size-md",
	"lg": "iconbutton-size-lg",
	"xl": "iconbutton-size-xl",
}

var iconButtonSizeIconOnlyStyles = hanariu.Boson{
	"xs": "iconbutton-sizeicononly-xs",
	"sm": "iconbutton-sizeicononly-sm",
	"md": "iconbutton-sizeicononly-md",
	"lg": "iconbutton-sizeicononly-lg",
	"xl": "iconbutton-sizeicononly-xl",
}

var iconButtonNotReverseStyles = hanariu.Boson{
	"xs": "iconbutton-notreverse-xs",
	"sm": "iconbutton-notreverse-sm",
	"md": "iconbutton-notreverse-md",
	"lg": "iconbutton-notreverse-lg",
	"xl": "iconbutton-notreverse-xl",
}

var iconButtonReverseStyles = hanariu.Boson{
	"xs": "iconbutton-reverse-xs",
	"sm": "iconbutton-reverse-sm",
	"md": "iconbutton-reverse-md",
	"lg": "iconbutton-reverse-lg",
	"xl": "iconbutton-reverse-xl",
}
